        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                <div class="top-left-part">
                    <!-- Logo -->
                    <a class="logo" href="<?php echo site_url('dosen/');?>">
            ...
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    <li style="padding: 70px 0 0;">
                        <a href="<?php echo site_url('dosen/');?>" class="waves-effect"><i class="fa fa-clock-o fa-fw" aria-hidden="true"></i>Dashboard</a>
                    </li>
                    
                    <li>
                        <a href="<?php echo site_url('dosen/uploadpdf');?>" class="waves-effect"><i class="fa fa-file-pdf-o fa-fw" aria-hidden="true"></i>Data PDF</a>
                    </li>
                    <li>
                        <a href="<?php echo site_url('dosen/uploadpdf_abs');?>" class="waves-effect"><i class="fa fa-file-pdf-o fa-fw" aria-hidden="true"></i>Data PDF Abstrak</a>
                    </li>
                    <li>
                        <a href="<?php echo site_url('dosen/uploadpdf_bab1');?>" class="waves-effect"><i class="fa fa-file-pdf-o fa-fw" aria-hidden="true"></i>Data PDF BAB 1</a>
                    </li>
                    <li>
                        <a href="<?php echo site_url('dosen/uploadpdf_bab2');?>" class="waves-effect"><i class="fa fa-file-pdf-o fa-fw" aria-hidden="true"></i>Data PDF BAB 2</a>
                    </li>
                    <li>
                        <a href="<?php echo site_url('dosen/listpkmku');?>" class="waves-effect"><i class="fa fa-table fa-fw" aria-hidden="true"></i>Daftar PKM-Ku</a>
                    </li>
